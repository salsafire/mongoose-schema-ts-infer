...
declare type Type = StringConstructor | DateConstructor | ObjectConstructor | NumberConstructor | typeof mongoose.Types.ObjectId;
...
declare type ConvertSchemaTypeToTypescriptType<T extends Type> = T extends StringConstructor ? string : T extends DateConstructor ? Date : T extends NumberConstructor ? number : T extends ObjectConstructor ? Record<string, unknown> : T extends typeof mongoose.Types.ObjectId ? mongoose.Types.ObjectId : never;
...
declare type ConvertShorthandNotation<T extends ShorthandNotation> = MaybeRequired<ConvertSchemaTypeToTypescriptType<T>, false>;
declare type ConvertClassicNotation<Field extends ClassicNotation> = MaybeRequired<EnumOrType<ConvertSchemaTypeToTypescriptType<Field['type']>, Field['enum']>, Field['required']>;
